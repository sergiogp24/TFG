                                    ...
                                    <table class="table table-bordered align-middle text-center usuarios-table table-fit">
                                        ...
                                        <tbody>
                                            ...
                                            <?php if (empty($maintenanceRows)): ?>
                                                <tr>
                                                    <td colspan="12" class="text-muted">No hay información</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered align-middle text-center usuarios-table table-fit">
                                        ...
                                        <tbody>
                                            ...
                                            <?php if (empty($maintenanceRows)): ?>
                                                <tr>
                                                    <td colspan="3" class="text-muted">No hay información</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered align-middle text-center usuarios-table table-fit">
                                        ...
                                        <tbody>
                                            ...
                                            <?php if (empty($maintenanceRows)): ?>
                                                <tr>
                                                    <td colspan="6" class="text-muted">No hay información</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered align-middle text-center usuarios-table table-fit">
                                        ...
                                        <tbody>
                                            ...
                                            <?php if (empty($maintenanceRows)): ?>
                                                <tr>
                                                    <td colspan="5" class="text-muted">No hay información</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered align-middle text-center usuarios-table table-fit">
                                        ...
                                        <tbody>
                                            ...
                                            <?php if (empty($maintenanceRows)): ?>
                                                <tr>
                                                    <td colspan="4" class="text-muted">No hay información</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                                            ...
                                            <form method="post" action="../controller/mantenimiento_controller.php">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-3"><label class="form-label">Género responsable</label><select class="form-select" name="genero_responsable" required>
                                                                <option value="">-- Seleccionar --</option>
                                                                <option value="Masculino">Masculino</option>
                                                                <option value="Femenino">Femenino</option>
                                                            </select></div>
                                                        <div class="col-md-3"><label class="form-label">Género promocionado</label><select class="form-select" name="genero_promocionado" required>
                                                                <option value="">-- Seleccionar --</option>
                                                                <option value="Masculino">Masculino</option>
                                                                <option value="Femenino">Femenino</option>
                                                            </select></div>
                                                        <div class="col-md-3"><label class="form-label">Interna / Externa</label><select class="form-select" name="interna_externa">
                                                                <option value="">-- Seleccionar --</option>
                                                        ...
                                                        <div class="col-md-4"><label class="form-label">Conciliación</label><select class="form-select" name="disfruta_conciliacion">
                                                                <option value="">-- Seleccionar --</option>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered align-middle text-center usuarios-table table-fit">
                                        ...
                                        <tbody>
                                            ...
                                            <?php if (empty($maintenanceRows)): ?>
                                                <tr>
                                                    <td colspan="8" class="text-muted">No hay información</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                                            ...
                                            <form method="post" action="../controller/mantenimiento_controller.php">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-6"><label class="form-label">Responsable</label><input class="form-control" name="responsable" required></div>
                                                        <div class="col-md-3"><label class="form-label">Género cargo responsable</label><select class="form-select" name="crgo_responsable" required>
                                                                <option value="">-- Seleccionar --</option>
                                                                <option value="Masculino">Masculino</option>
                                                                <option value="Femenino">Femenino</option>
                                                            </select></div>
                                                        <div class="col-md-3"><label class="form-label">Género seleccionado</label><select class="form-select" name="gnro_seleccionado" required>
                                                                <option value="">-- Seleccionar --</option>
                                                                <option value="Masculino">Masculino</option>
                                                                <option value="Femenino">Femenino</option>
                                                            </select></div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered align-middle text-center usuarios-table table-fit">
                                        ...
                                        <tbody>
                                            ...
                                            <?php if (empty($maintenanceRows)): ?>
                                                <tr>
                                                    <td colspan="10" class="text-muted">No hay información</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
